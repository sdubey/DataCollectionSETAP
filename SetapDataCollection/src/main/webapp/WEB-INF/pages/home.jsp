	...
	<div id="container">
		...
		<div class="page_content">
			...
			<p>
				...
				logs. <br>
				<br> The project mainly provides two functionalities :<br>
				<br> Select Term/Semester (Default Selection is Current Semester)
			...
			%>		  
			<option value="1"><%= entry.getValue()%></option>
			<%
			}
			%>
			</select> <br><br>
